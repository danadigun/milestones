	...
	$.fn.jshowoff = function(settings) {
		...
		this.each(function(i) {
			...
			function addControls() {
			    $wrap.append('<p class="jshowoff-controls ' + uniqueClass + '-controls"> <a class="jshowoff-prev ' + uniqueClass + '-prev" href="#null"><img src="http://milestonescenter.org/Images/Arrowhead-Left-01.png"/></a> <a class="jshowoff-next ' + uniqueClass + '-next" href="#null"><img src="http://milestonescenter.org/Images/Arrowhead-Right-01.png"/></a></p>');
